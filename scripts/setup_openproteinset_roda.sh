...
echo "1) Set up official public data:"
echo "   bash scripts/setup_official_data.sh"
echo ""
echo "Maintainers can generate hidden validation after creating a private salt:"
echo "   python scripts/build_hidden_manifest.py --hidden-split-salt-file .nanofold_private/secrets/hidden_split_salt.txt"
echo ""
