...
echo "1) Refresh official manifests and processed data:"
echo "   export NANOFOLD_HIDDEN_SPLIT_SALT='<maintainer-private-random-string>'"
echo "   bash scripts/full_official_data_refresh.sh --rewrite-lock"
echo "   # hidden outputs land under .nanofold_private/"
echo ""
