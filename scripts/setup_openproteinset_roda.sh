...
echo "   python scripts/make_manifest.py --chain-data-cache $PDB_DIR/data_caches/chain_data_cache.json --out-dir data/manifests --seed 0"
echo ""
echo "2) Preprocess train split:"
echo "   python scripts/preprocess.py --alignments-root $ALIGN_DIR --mmcif-root $PDB_DIR/mmcif_files --manifest data/manifests/train.txt --processed-dir data/processed"
echo ""
echo "3) Preprocess val split:"
echo "   python scripts/preprocess.py --alignments-root $ALIGN_DIR --mmcif-root $PDB_DIR/mmcif_files --manifest data/manifests/val.txt --processed-dir data/processed"
